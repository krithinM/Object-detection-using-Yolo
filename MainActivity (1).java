...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
   ...
   // Button canny;
            ...
            public void onClick(View view) {
                if(startYolo==false)
                {
                    ...
                    if(firstTimeYolo == false)
                    {
                        ...
                        String cfgPath = "/storage/emulated/0/Android/data/com.example.androidyolo/files/Download/dnns/a.cfg";
                        String weightsPath = "/storage/emulated/0/Android/data/com.example.androidyolo/files/Download/dnns/b.weights";
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        //code to change the detected frame to gray scale
        /*if (counter % 2 == 0){
